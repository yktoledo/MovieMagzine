...
public class Upcoming extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(isOnline()) {
            ...
            rvUpcomingFrag = (RecyclerView) v.findViewById(R.id.rvUpcoming_frag_id);
                ...
                public void onResponse(Call<Movies> call, Response<Movies> response) {
                    ...
                    if(body!=null) {
                        ...
                        if(i==8) {
                            ...
                            rvUpcomingFrag.setLayoutManager(new GridLayoutManager(getContext(), 3));
                            rvUpcomingFrag.setAdapter(adapter);
